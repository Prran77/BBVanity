      ...
      <div className="about-content">
        ...
        <section className="about-section">
          ...
          <p>
            ...
            observations, and commentary on various topics. They've become a beloved part of 
            the show, offering a glimpse into Lorre's thoughts and sense of humor.
          </p>
          <p>
            The vanity cards appear so briefly on screen that they're nearly impossible to read 
        ...
        <div className="credits">
          <p>Made with ❤️ by a fan for fans</p>
